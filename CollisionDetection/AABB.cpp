...
AABB::AABB(glm::vec2 position, glm::vec2 velocity, float mass, float width, float height, float rotation, glm::vec4 colour) : Rigidbody(ShapeType::AABB, position, velocity, rotation, mass)
{
	m_width = width;
	m_height = height;
	m_colour = colour;
