...
physicsSimulation2DApp::physicsSimulation2DApp() {
...
bool physicsSimulation2DApp::startup() {
	
	//increase the 2nd line count to maximize the number of objects we can draw
...
void physicsSimulation2DApp::shutdown() {

	delete m_font;
	delete m_2dRenderer;
}

void physicsSimulation2DApp::update(float deltaTime) {
...
void physicsSimulation2DApp::draw() {
